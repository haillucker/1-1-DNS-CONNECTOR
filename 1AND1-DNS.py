...
my_url = raw_input('[X] ENTER [ACCOUNT LOGIN] 1&1 URL WITH HTTPS X> ')
admin_url = raw_input('[X] ENTER [PANEL ADMIN] 1&1 URL WITH HTTPS X> ')
...
if 'Logout' in driver.page_source:
	...
	# RED TO DOMAINS PAGE
	domains_list_url = admin_url + '/domains?__lf=HomeFlow'
	driver.get(domains_list_url)
	print '[X] VISITED DOMAINS LIST PAGE.'
	# ADDING DNS NOW
	for domain in file:
		domain = domain.strip()
		domain_dns_url = admin_url + '/add-dns-record/' + domain + '?__lf=HomeFlow'
